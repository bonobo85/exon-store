...
3. Click on **ÔÜÖ´©Å Project Settings** (gear icon)
...
2. Navigate to **Site Settings** ÔåÆ **Build & deploy** ÔåÆ **Environment**
...
Ôö£ÔöÇÔöÇ password: string
Ôö£ÔöÇÔöÇ cart: array
Ôö£ÔöÇÔöÇ wishlist: array
Ôö£ÔöÇÔöÇ purchaseHistory: array
ÔööÔöÇÔöÇ createdAt: timestamp
```
...
```
(auto-generated ID)
Ôö£ÔöÇÔöÇ type: string (register, login)
Ôö£ÔöÇÔöÇ identifier: string
Ôö£ÔöÇÔöÇ success: boolean
ÔööÔöÇÔöÇ timestamp: timestamp
```
...
### What Changed
- **Database:** Neon PostgreSQL ÔåÆ Firebase Firestore
...
- **Data Format:** SQL ÔåÆ Firestore documents (automatically handled by API)
